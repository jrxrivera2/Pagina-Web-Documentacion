...
drop function if exists public.registrar_descarga(uuid, uuid, text) cascade;
drop function if exists public.actualizar_estado_documento(uuid) cascade;
drop function if exists public.es_emisor_o_admin() cascade;
drop function if exists public.puede_crear_documento(uuid) cascade;
drop function if exists public.crear_documento(text, text, text, uuid) cascade;
drop function if exists public.agregar_destinatarios_documento(uuid, uuid[]) cascade;
drop function if exists public.registrar_archivo_documento(uuid, text, text, text, bigint, integer) cascade;
drop function if exists public.actualizar_estado_caso(uuid, text) cascade;
